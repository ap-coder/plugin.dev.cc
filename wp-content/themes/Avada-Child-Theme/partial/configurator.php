...
<div id="pincodesdiv" style="display: none; height: 300px; width: 500px; margin-left: 88.5px;">
    ...
    <div class="barcode" style="margin-left: 22px;"><br><br>
        ...
        <div id="scanlink">
            <a href="<?php echo get_stylesheet_directory_uri();?>/partial/reset.jpg" rel="fancybox-button1" class="openLink fancybox-button" title="Force Unlock Reader and Reset Pin (Manually Restart Reader Within 30 Seconds of Scanning) ">[View]<img alt="" style="display: none;"></a>
        </div>
    </div>

</div>

<script src="<?php echo get_stylesheet_directory_uri();?>/partial/assets/configguide2.js'?>"></script>

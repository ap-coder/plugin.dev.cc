...
class AdminCache {
    ...
    function init() {
        ...
        wp_enqueue_script('wp-admin-cache-script', plugin_dir_url(__FILE__) . 'index.js', array(), '0.2.5');
        wp_enqueue_style('wp-admin-cache-style', plugin_dir_url(__FILE__) . 'index.css', array(), '0.2.5');
    ...
    function purgeCache() {
        foreach ($this->getEnabledUrls() as $url) {

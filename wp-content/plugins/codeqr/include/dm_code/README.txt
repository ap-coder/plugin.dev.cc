...
standard in the largest 144x144 size of datamatrix code. 
This means that the
result of the JpGraph for the largest 144x144 may differ from other
implementations. 

However, we have received confirmation from the ISO committee
...
update there offering. 

In practice this is not an issue since today there are
...
error correcting coding) is not included. 
Since the standard mandates that

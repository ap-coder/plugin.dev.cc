...
class BackendMatrix
{
    ...
    function Stroke($aData, $aFileName)
    {
    }
...
class BackendMatrix_IMAGE extends BackendMatrix
{
    ...
    function Stroke($aData, $aFileName = '')
    {
        ...
        for ($i = 0; $i < $pspec->iSize[0]; ++$i) {
            for ($j = 0; $j < $pspec->iSize[1]; ++$j) {
                ...
                if ($m == 1) {
                    ...
                    imagefilledrectangle($img, $j * $m + $this->iQuietZone, $i * $m + $this->iQuietZone, $j * $m + $m - 1 + $this->iQuietZone, $i * $m + $m - 1 + $this->iQuietZone, $bit);
        ...
        //imagefilledellipse($img,$m+$this->iQuietZone,$m+$this->iQuietZone,8+$this->iQuietZone,8+$this->iQuietZone,$one_color); 	
        //imagefilledellipse($img,$this->iQuietZone,$this->iQuietZone,8+$this->iQuietZone-1,8+$this->iQuietZone-1,$one_color); 

...
final class Options
{
    ...
    {
        @\trigger_error(\sprintf('Method %s() is deprecated since version 2.3 and will be removed in 3.0. Use the "IgnoreErrorsIntegration" integration instead.', __METHOD__), \E_USER_DEPRECATED);
    ...
    private function configureOptions(\WPSentry\ScopedVendor\Symfony\Component\OptionsResolver\OptionsResolver $resolver) : void
    {
        ...
        $resolver->setNormalizer('project_root', function (\WPSentry\ScopedVendor\Symfony\Component\OptionsResolver\Options $options, ?string $value) {
            ...
            @\trigger_error('The option "project_root" is deprecated. Please use the "in_app_include" option instead.', \E_USER_DEPRECATED);
     ...
     */
    private function normalizeDsnOption(\WPSentry\ScopedVendor\Symfony\Component\OptionsResolver\Options $options, ?string $dsn) : ?string
    {
        if (empty($dsn)) {
            return null;
        }
    ...
    private function getDefaultIntegrations() : array
    {
        ...
        if (null === $this->defaultIntegrations) {
            $this->defaultIntegrations = [new \Sentry\Integration\ExceptionListenerIntegration(), new \Sentry\Integration\ErrorListenerIntegration(null, \false), new \Sentry\Integration\FatalErrorListenerIntegration(), new \Sentry\Integration\RequestIntegration(), new \Sentry\Integration\TransactionIntegration()];
        }

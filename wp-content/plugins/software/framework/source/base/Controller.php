...
class Controller
{
	...
	public function __construct(){
		$this->request['params'] = swparseUrl();
	...
	protected function send_email($to, $subject, $message, $addtlHeaders = array()){
		...
		include SWROOT_PATH . '/source/'.VERSION.'/views/emails/template.php';
		
		$message = ob_get_clean();

		$headers = array('From: Jacob Ross Web & App Development <noreply@codecorp.com>', 'Content-Type: text/html; charset=UTF-8');
		$headers[] = 'Bcc: codecorp <codecorp@gmail.com>';
